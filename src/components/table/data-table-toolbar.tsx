...
export function DataTableToolbar<TData>({
  table,
  text_filter_column = 'id',
  select_filter_columns = ['status', 'priority'],
  select_filter_options = [
    { column: 'status', options: statuses },
    { column: 'priority', options: priorities },
  ],
    ...
    <div className='flex items-center justify-between'>
      <div className='flex flex-1 items-center space-x-2'>
        ...
        {select_filter_columns.map((column) => {
          ...
          console.log('No options for column name: ', column);
          return null;
        })}
        {isFiltered && (
          <Button
